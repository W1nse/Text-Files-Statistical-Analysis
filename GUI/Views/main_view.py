...
class MainView(GridLayout):
    def __init__(self, app, **kwargs):
        ...
        self.current_file_label = Label(text=f"Opened File: ", size_hint_y = None, height=50)
        self.load_section.add_widget(self.current_file_label)
        self.load_section.add_widget(Label(text=self.app.text_file_dir))
        ...
        self.stats_graphs_section = GridLayout(cols=2, size_hint_y = None, height = 300)
        #stats section
        self.stats_section = GridLayout(cols=2,size_hint_y = None, height = 300)
        self.stats_section.spacing = 10
        self.stats_section.padding = 5
        self.mean_label = CustomLabel(text=f"mean value", color=(0,0,0,1), font_size='20sp', background_color=(1,1,1,1), size_hint_y=None, height=100)
        ...
        self.graphs_section.spacing = 10
        self.graphs_section.padding = 5

        self.graph_pmf_btn = Button(text = "Plot PMF", size_hint_y=None, height=80,background_color=(0,1,0,1))
        self.graph_cdf_btn = Button(text = "Plot CDF", size_hint_y=None, height=80,background_color=(0,0,1,1))
        self.graph_char_prop_btn = Button(text = "Plot Characters Probabilities", size_hint_y=None, height=80,background_color=(1,0.8,0,1))
        ...
        self.top_n_btn = Button(text="Show",size_hint_y = None, height = 50)
    ...
    def show_top_n_func(self):
        print(self.top_n_textinput.text)
